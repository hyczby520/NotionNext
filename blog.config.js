...
const BLOG = {
  ...
  AUTHOR: 'pmzd', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://www.hyczby.com', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: '1@1.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/hyczby520', // 你的github个人主页
  CONTACT_TELEGRAM: 'https://t.me/hyczby5218', // 你的telegram 地址 例如 https://t.me/hyczby5218
  ...
  MUSIC_PLAYER_METING_ID: process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '110079425', // 对应歌单的 id
